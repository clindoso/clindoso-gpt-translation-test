import argparse
from translation_package.translator.main import main as tr_main
from translation_package.tm_aligner.tm_aligner import main as al_main

def main():
    # Create a top-level parser
    parser = argparse.ArgumentParser(prog='translation_project', description='Translate articles, align TM segments, and extract prompts to fine tune a ChatGPT model.')
