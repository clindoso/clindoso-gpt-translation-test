...
| handled     | Numero intero   | Sì      | Per intervallo: Quantità di contatti che sono stati processati nell’intervallo<br>Per contatto: Il valore 1 indica che il contatto è stato processato. Il valore 0 indica che il contatto non è stato processato. |
...
[Configura un’integrazione CSV](#configurare-una-nuova-integrazione-csv) e connetti injixo Cloud Link. injixo Cloud Link importerà periodicamente nuovi dati in injixo cercando file CSV nella sua cartella di installazione. Durante l’installazione puoi modificare la cartella di installazione predefinita, che è C:\\Program Files\\injixo Cloud Link.
...
Dopo che i dati sono stati caricati, puoi {% link_new aggiungere delle nuove code a un workload | features/forecast/injixo-forecast/create-workloads.md %} in Forecast, oppure vedrai i dati aggiornati nei workload esistenti. Se non vengono caricati dei dati, utilizza l’importazione manuale descritta qui di seguito per verificare che il formato del file sia valido.
...
Dopo che i dati sono stati elaborati, potrai {% link_new aggiungere le code a un workload | features/forecast/injixo-forecast/create-workloads.md %} in injixo Forecast. Le dimensioni massime del file sono 7 MB.

## Domande frequenti

| Domanda                                                                  | Risposta                                                                                                                                                                                                                                                                                   |
| ------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Posso importare due volte lo stesso file?                                         | Sì, se importi i dati manualmente. No, se utilizzi Cloud Link. Per identificare file duplicati, injixo calcola i checksum durante l’importazione. I file importati con lo stesso checksum non saranno importati di nuovo. Se però il file ha lo stesso nome, ma contenuto diverso, il checksum cambierà, e il file verrà importato di nuovo. |
