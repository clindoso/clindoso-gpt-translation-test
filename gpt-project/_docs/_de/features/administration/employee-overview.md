...
In injixo gibt es zwei Stellen, an denen du Mitarbeiter erstellen und bearbeiten kannst, je nach Anwendungsfall. In der folgenden Tabelle erfährst du, wo sich die verschiedenen Stellen für die Mitarbeiterkonfiguration in injixo befinden und was du dort jeweils tun kannst.

| Stelle                                 | Mögliche Aktionen                                            |
| -------------------------------------- | ------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------- |
| **People**                             | - {% link_new Mitarbeiter erstellen und verwalten            | features/people/configure-people-settings.md %}<br>- Kontakt- und Addressdaten von Mitarbeitern verwalten<br>- Zugriffsrechte über Rollen verwalten<br>- Gesperrte Mitarbeiter entsperren<br>- Neues Passwort für Mitarbeiter festlegen<br>- Überprüfen, welche Mitarbeiter {% link_new abgerechnet werden | getting-started/manage-user-accounts.md %} und welche nicht<br>- {% link_new Mitarbeiter löschen                               | getting-started/manage-user-accounts.md %}, damit sie für dein Unternehmen nicht mehr abgerechnet werden |
| **Plan > Konfiguration > Mitarbeiter** | {% link_new Mitarbeiter für die Schichtplanung konfigurieren | features/administration/employee-overview.md                                                                                                                                                                                                                                                               | #übersicht-über-die-mitarbeitereinstellungen %}. Mitarbeiter ohne zugewiesene Planungseinheiten erscheinen nicht in der Liste. |

> Die Liste unter _Plan > Konfiguration > Mitarbeiter_{:.breadcrumbs} zeigt nicht automatisch alle Mitarbeiter im Unternehmen an
>
> Unter _Plan > Konfiguration > Mitarbeiter_{:.breadcrumbs} können Mitarbeiter ohne Adminrechte nur die Mitarbeiter sehen, die den Planungseinheiten zugewiesen sind, auf die sie mindestens Lesezugriff haben. Wenn Mitarbeiter keiner solchen Planungseinheit zugewiesen sind oder wenn sie für den aktuellen Tag {% link_new keine gültige Zuweisung zur Planungseinheit | features/people/configure-people-settings.md %} haben, werden sie nicht in der Liste angezeigt, selbst wenn die Option **Alle** bei den Dropdown-Menüs für die Planungseinheit und Auswahl ausgewählt ist. Mitarbeiter mit Adminrechten können immer alle Mitarbeiter im Unternehmen sehen.
