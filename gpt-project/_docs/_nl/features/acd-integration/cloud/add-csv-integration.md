...
| ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------- |
| **Agenten-ID**    | Unieke ID voor de agent, bijvoorbeeld ID of naam                                                                                                                                                                                                                                     | Ja      |
...
| offered     | Heel getal   | Ja      | Aantal contacten (bijvoorbeeld oproepen of e-mails) tijdens de interval                                                                                                                                               |
...
In dit voorbeeld is geen kanaalkolom opgenomen. Selecteer in de CSV-schemaconfiguratie de optie **Kanaal**. Om het kanaal in te stellen voor bijvoorbeeld oproepen, selecteer je **Oproepen** in het vervolgkeuzemenu.
