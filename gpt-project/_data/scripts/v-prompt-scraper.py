...
# Use this script to scrape the content from English articles and Spanish articles and write them in prompt format for OpenAI API.
...
argparser = argparse.ArgumentParser(description="Script to scrape files from directories")
...
scraped_data_file_path = os.path.join(base_dir, 'md_validation_data.jsonl')
